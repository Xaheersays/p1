        ...
        <div className=' flex gap-10 flex-col md:flex-row '>
            ...
            <div className=' flex gap-10'>
                ...
                <div className='flex flex-col justify-around gradient__text text-xl'>
                    <div style={{'marginTop':-8}}>From they fine john he give of rich he. They age and draw mrs like. Improving end distrusts may instantly was household applauded.</div>
